...
# ANOTHER WAY TO USE ThreadPoolExecutor is by using map method
# The map() method is used to apply a function to all the elements of specified iterable and 
# return a list of the results.


def threadpooldemo():
    with ThreadPoolExecutor() as executor:
        results = executor.map(worker, [5, 3, 2])
